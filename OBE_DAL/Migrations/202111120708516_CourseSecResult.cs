namespace OBE_DAL.Migrations
{
    ...
    public partial class CourseSecResult : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Assignment1 = c.Decimal(precision: 18, scale: 2),
                        Assignment2 = c.Decimal(precision: 18, scale: 2),
                        Assignment3 = c.Decimal(precision: 18, scale: 2),
                        Assignment4 = c.Decimal(precision: 18, scale: 2),
                        Quiz1 = c.Decimal(precision: 18, scale: 2),
                        Quiz2 = c.Decimal(precision: 18, scale: 2),
                        Quiz3 = c.Decimal(precision: 18, scale: 2),
                        Quiz4 = c.Decimal(precision: 18, scale: 2),
                        Midterm = c.Decimal(precision: 18, scale: 2),
                        Terminal = c.Decimal(precision: 18, scale: 2),
                    })
